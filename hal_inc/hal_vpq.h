...
/* TwinTv Mode */
DTV_STATUS_T HAL_VPQ_SetTwinTvMode(BOOLEAN bOnOff);
...
DTV_STATUS_T HAL_VPQ_SetDolbyBackLight(BOOLEAN bOnOff, UINT8 uBacklight);
DTV_STATUS_T HAL_VPQ_SetDolbyBrightness(BOOLEAN bOnOff, UINT8 uBrightness);
