...
**/
typedef enum{
	DISP_PANEL_ORBIT_JUSTSCAN_MODE = 0,
	DISP_PANEL_ORBIT_AUTO_MODE,
	DISP_PANEL_ORBIT_STORE_MODE,
	DISP_PANEL_ORBIT_MODE_MAX
}DISP_PANEL_ORBIT_MODE_T;
...
DTV_STATUS_T HAL_VBE_DISP_SetOrbit (BOOLEAN bOnOff, DISP_PANEL_ORBIT_MODE_T nMode);
DTV_STATUS_T HAL_VBE_DISP_SetPartialFramemodeOrbit(BOOLEAN bOnOff);
...
DTV_STATUS_T HAL_VBE_DISP_GetOSDAlphaAPL(UINT32 *alphaTbl, UINT32 size);
DTV_STATUS_T HAL_VBE_DISP_SetOSDRGBLevel(BOOLEAN bOnOff, UINT32 *lvlTbl, UINT32 size);
DTV_STATUS_T HAL_VBE_DISP_GetOLEDGSRStatus(BOOLEAN *bOnOff);
