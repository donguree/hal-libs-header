 ...
 * @endrst
 */
DTV_STATUS_T HAL_DRM_SetSecureData(SINT8 *data_id, UINT8 *data, UINT32 length);
 ...
 * @endrst
 */
DTV_STATUS_T HAL_DRM_DeleteSecureData(SINT8 *data_id);
 ...
 * @endrst
 */
DTV_STATUS_T HAL_DRM_GetSecureClock (UINT64 *secure_clock);
 ...
 * @endrst
 */
DTV_STATUS_T HAL_DRM_SetSecureClock (UINT64 secure_clock);
 ...
 * @endrst
 */
DTV_STATUS_T HAL_DRM_AESHWInit (SINT32 mode, UINT8 *key, UINT8 *iv, SINT32 operation, SINT32 is_padding);
 ...
 * @endrst
 */
DTV_STATUS_T HAL_DRM_AESHWUpdate (UINT8 *out_data, UINT32 *out_size, UINT8 *in_data, UINT32 in_size);
 ...
 * @endrst
 */
DTV_STATUS_T HAL_DRM_AESHWFinish (UINT8 *out_data, UINT32 *out_length);
 ...
 * @endrst
 */
DTV_STATUS_T HAL_DRM_WriteWidevineKeyBox(UINT8 *wv_key, SINT32 length);
 ...
 * @endrst
 */
DTV_STATUS_T HAL_DRM_GetWidevineDeviceID(UINT8 *device_id,  SINT32 *length);
 ...
 * @endrst
 */
DTV_STATUS_T HAL_DRM_UHDCP_Decrypt(UINT8 *data, UINT32 data_size,
                                   UINT8 *iv, UINT8 *kid, ULONG block_offset, UINT16 byte_offset);
 ...
 * @endrst
 */
DTV_STATUS_T HAL_DRM_HDMI_GetSecureDataforHDCP22(SINT8 *data_id, UINT8 *data);
 ...
 * @endrst
 */
DTV_STATUS_T HAL_DRM_HDMI_SetSecureDataforHDCP22(SINT8 *data_id, UINT8 *data, UINT32 length);
...
// legacy functions, these will be removed before webOS 23 is released.
DTV_STATUS_T HAL_DRM_JPMARLIN_CheckSecretData(SINT32 secretDataType);
DTV_STATUS_T HAL_DRM_JPMARLIN_WriteSecretData(SINT32 secretDataType, UINT8 *pRootCert,
       	                                      SINT32 rootCertLen, UINT8 *pCaCert,
                                              SINT32 caCertLen, UINT8 *pClientCert,
                                              SINT32 clientCertLen, UINT8 *pClientKey,
                                              SINT32 clientKeyLen);
