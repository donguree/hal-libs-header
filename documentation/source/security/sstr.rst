...
- These keys are injected through a hal interface called CRYPTO, and this document does not deal with that CRYPTO HAL API. You can see CRYPTO HAL API in :doc:`CRYPTO document </part3/hal-libs-header/documentation/source/security/crypto>`.
