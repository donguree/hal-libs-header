...
DTV_STATUS_T HAL_HDCP2_GetCertInfo2(UINT8 *pReceiverID, UINT8 *pPubKey, UINT8 *pReserved, UINT8 *pRootSign);
...
int HAL_HDCP2_Compute_V_Prime (unsigned char *pVPrime, unsigned char *pRxIdListsInfo, int infoLength );
int HAL_HDCP2_Compute_M_Prime (unsigned char *pMPrime, unsigned char *pStreamManageInfo, int infoLength);
