...
DTV_STATUS_T HAL_VFE_AVD_GetTTXData(VFE_AVD_TTX_DATA_T *pttx_data);
DTV_STATUS_T HAL_VFE_AVD_GetVPSData(VFE_AVD_VPS_DATA_T *pvps_data);
DTV_STATUS_T HAL_VFE_AVD_GetWSSData(VFE_AVD_WSS_DATA_T *pwss_data);
